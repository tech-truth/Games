...
export default function MemoryFlipGame({ onBack }) {
  const {
    cards,
    level,
    score,
    ...
    <div className={`app ${darkMode ? 'dark' : ''}`}>
      <header className="app-header">
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          <button className="icon-btn" onClick={onBack} aria-label="Back to game selection" title="Back to games">
            ← Games
          </button>
